      ...
      <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-300">
        ...
        >
          {items.map((item) => (
            <div
              key={item.id}
              className="bg-white p-4 rounded-lg shadow-md border border-gray-300 hover:shadow-lg transition-all duration-300"
            >
              {editingItemId === item.id ? (
                ...
                <div>
                  ...
                  <h3
                    className="text-xl font-semibold mb-2 overflow-hidden text-ellipsis h-18"
